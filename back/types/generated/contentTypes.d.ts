...
export interface ApiCountryCountry extends Schema.SingleType {
  ...
  attributes: {
    item: Attribute.Component<'misc.country-item', true>;
    createdAt: Attribute.DateTime;
    updatedAt: Attribute.DateTime;
    createdBy: Attribute.Relation<
      'api::country.country',
...
export interface ApiPagePage extends Schema.CollectionType {
  ...
  attributes: {
    seo: Attribute.Component<'page-item.seo'> &
      Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
    ...
    content: Attribute.DynamicZone<
      [
        ...
        'page-item.recruit',
        'page-item.licenses',
        'page-item.history-slider',
        'page-item.profiles',
        'page-item.interview-slider',
        'page-item.faq-list',
        'page-item.pipeline'
      ]
    > &
...
export interface ApiPressPress extends Schema.CollectionType {
  ...
  attributes: {
    ...
    body: Attribute.RichText &
      ...
      >;
    page: Attribute.Relation<'api::press.press', 'oneToOne', 'api::page.page'>;
    createdAt: Attribute.DateTime;
    updatedAt: Attribute.DateTime;
    publishedAt: Attribute.DateTime;
    createdBy: Attribute.Relation<
...
export interface ApiRecruitRecruit extends Schema.SingleType {
  collectionName: 'recruits';
  info: {
    singularName: 'recruit';
    pluralName: 'recruits';
    displayName: '\uBAA8\uC9D1\uC9C1\uAD70';
    description: '';
  };
  ...
  attributes: {
    item: Attribute.Component<'page-item.recruit', true>;
    active: Attribute.Boolean;
    createdAt: Attribute.DateTime;
    updatedAt: Attribute.DateTime;
    publishedAt: Attribute.DateTime;
...
export interface ApiSettingSetting extends Schema.SingleType {
  ...
  attributes: {
    footer: Attribute.Component<'misc.footer-info', true> &
      Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
...
declare module '@strapi/types' {
  export module Shared {
    export interface ContentTypes {
      ...
      'api::recruit.recruit': ApiRecruitRecruit;
