...
<Section>
    <div class="grid grid-cols-2 gap-8 phone:grid-cols-1">
        <div class="flex flex-col justify-center gap-4">
            ...
            <p>우리는 유전자 편집 기술의 잠재력을 최대한 발휘하기 위한 중요한 여정에 있으며, 우리의
                성공은 역동적이고 열정적이며 다양한 팀에 의해 주도되고 있습니다. 전 세계에서 심각한
                질병을 앓고 있는 사람들을 위한 혁신적인 의약품을 개발합니다.</p>
        </div>
    ...
    <div class="grid grid-cols-[1fr,2fr] gap-20 relative phone:grid-cols-1 phone:gap-2">
        ...
        <div class="grid gap-8 phone:gap-2">
            ...
            <p>
                ...
                •등록된 입사지원서는 채용담당자에게 전달되며, 지원하신 해당 직무와 관련하여 인력수요 발생시 적합한 인재는 별도의 채용절차를 통해 채용을 진행할 수 있습니다.<br>
