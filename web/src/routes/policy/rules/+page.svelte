...
<span style="font-weight:bold;">제 2 조 【 용어의 정의 】 </span>
    ...
    ② 이 규정에서 "공시책입자"라 함은 공시규정 제2조제4항에 따라 회사를 대표하여 신고업무를 수행할 수 있는 자를 말한다.	
...
<span style="font-weight:bold;">제 5 조 【 공시책임자 】 </span>
    ...
    ② 공시책임자는 내부정보관리제도의 수립 및 운영에 관련된 업무를 총괄하며 다음 각 호의 업무를 수행한다.
        <span style="padding-left:1rem;">1. 공시의 집행
        <span style="padding-left:1rem;">2. 내부정보관리제도의 운영 상황 점검 및 평가
        <span style="padding-left:1rem;">3. 내부정보에 대한 검토 및 공시 여부의 결정
        <span style="padding-left:1rem;">4. 임원, 직원에 대한 교육 등 내부정보관리제도의 운영을 위해 필요한 조치
        <span style="padding-left:1rem;">5. 내부정보의 관리를 담당하거나 공시업무를 담당하는 부서 또는 임원, 직원에 대한 지휘 및 감독
        <span style="padding-left:1rem;">6. 그 밖에 내부정보관리제도의 운영을 위해 필요하다고 대표이사가 인정한 업무
    ③ 공시책임자는 그 직무를 수행함에 있어서 다음 각 호의 권한을 가진다.
        <span style="padding-left:1rem;">1. 내부정보와 관련된 각종 서류 및 기록의 제출을 요구하고 열람할 수 있는 권한
        <span style="padding-left:1rem;">2. 회계 또는 감사업무를 담당하는 부서, 그 밖에 내부정보의 생성과 관련이 있는업무를 담당하는 부서의 임원, 직원으로부터 필요한 의견을 청취할 수 있는 권한
...
<span style="font-weight:bold;">제 6 조 【 공시담당자 】 </span>
    ① 대표이사 또는 공시책임자는 공시담당자를 정하여 지체 없이 거래소에 신고하여야 한다. 공시담당자를 변경한 때에도 또한 같다.
    ② 공시담당자는 내부정보관리와 관련하여 공시책임자의 지휘를 받으며 다음 각 호의 업무를 수행한다.
        <span style="padding-left:1rem;">1. 내부정보의 수집과 검토 및 공시책임자에 대한 보고
        <span style="padding-left:1rem;">2. 공시의 집행을 위해 필요한 업무
        <span style="padding-left:1rem;">3. 공시 관련 법규의 변경 등 내부정보의 관리를 위해 필요한 사항의 확인 및 공시책임자에 대한 보고
        <span style="padding-left:1rem;">4. 그 밖에 대표이사 또는 공시책임자가 필요하다고 인정한 사항

<span style="font-weight:bold;">제 7 조 【 내부정보의 집중 】 </span>
    ① 임원 및 각 부서의 장은 다음 각 호의 어느 하나에 해당하는 경우에 공시책임자에게 그에 관한 정보를 제공하여야 한다.
        <span style="padding-left:1rem;">1. 내부정보가 발생하거나 발생이 예상되는 경우
        <span style="padding-left:1rem;">2. 내부정보 중 이미 공시된 사항을 취소 또는 변경해야 할 사유가 발생하거나 발생이 예상되는 경우
        <span style="padding-left:1rem;">3. 그 밖에 공시책임자의 요구가 있는 경우
...
<span style="font-weight:bold;">제 8 조 【 내부정보의 사외제공 】 </span>
    ...
    ③ 제1항의 따라 내부정보를 제공함에 있어 공정공시의무가 발생하는 경우에는 이를 지체없이 공시하여야 한다(공시규정 제15조의 적용예외에 해당하는 경우는 제외한다).


<span style="font-weight:900;">제 3 장 내부정보의 공개</span>
<span style="font-weight:bold;">제 9 조 【 공시의 종류 】 </span>
    회사의 공시는 다음과 같이 구분한다.
    <span style="padding-left:1rem;">1. 공시규정 제1편 제2장 제1절에 따른 주요경영사항 신고 및 공시
    <span style="padding-left:1rem;">2. 공시규정 제1편 제2장 제2절에 따른 조회공시
    <span style="padding-left:1rem;">3. 공시규정 제1편 제2장 제3절에 따른 공정공시
    <span style="padding-left:1rem;">4. 공시규정 제1편 제3장에 따른 자율공시
    <span style="padding-left:1rem;">5. 법 제3편 제1장에 따른 증권신고서 등의 제출
    <span style="padding-left:1rem;">6. 법 제159조, 제160조 및 제165조와 공시규정 제1편 제2장 제4절에 따른 사업보고서 등의 제출
    <span style="padding-left:1rem;">7. 법 제161조에 따른 주요사항보고서의 제출
    <span style="padding-left:1rem;">8. 그 밖에 다른 법규에 따른 공시

<span style="font-weight:bold;">제 9 조의2 【 공시대상의 확인 】 </span>
...
<span style="font-weight:bold;">제 12 조의2 【 보도내용의 확인】 </span>
...
<span style="font-weight:bold;">제 13 조 【 기업설명회 】 </span>
    ① 대표이사는 IR활동이 상장법인의 경영책무임을 인식하고 자발적, 지속적으로 기업설명회를 개최하여 투자관계자와 신뢰를 구축하기 위해 노력하여야 한다.
...
<span style="font-weight:bold;">제 13 조의3 【 정보제공 요구 】 </span>
    ① 주주 및 이해관계자 등으로부터 회사와 관련된 정보공개를 요구받은 경우 공시책임자는 당해 요구의 적법성 등을 검토하여 관련 정보를 제공할 것인지 여부를 결정하여야 한다.
    ② 공시책임자는 정보의 제공 여부를 결정하기 위하여 제공을 요구받은 정보가 투자자의 투자판단 및 주가에 영향을 미칠 수 있는지 여부에 대하여 법무담당 부서 또는 외부 법률전문가 등의 의견을 청취할 수 있다.
    ③ 제1항의 결정에 따라 정보를 제공하는 경우에는 제12조 제4항을 준용한다.


<span style="font-weight:900;">제 4 장 내부자 거래 등에 대한 규제</span>
<span style="font-weight:bold;">제 14조 【 단기매매차익의 반환 】 </span>
    ...
    ③ 증권선물위원회가 제1항에 따른 단기매매차익의 발생사실을 회사에 통보한 경우 공시책임자는 지체 없이 다음 각 호의 사항을 회사의 인터넷 홈페이지에 공시하여야 한다.
        <span style="padding-left:1rem;">1. 단기매매차익을 반환해야 할 자의 지위
        <span style="padding-left:1rem;">2. 단기매매차익 금액
        <span style="padding-left:1rem;">3. 증권선물위원회로부터 단기매매차익 발생사실을 통보받은 날
        <span style="padding-left:1rem;">4. 단기매매차익 반환 청구 계획
        <span style="padding-left:1rem;">5. 회사의 주주가 회사로 하여금 단기매매차익을 얻은 자에게 단기매매차익의 반환청구를 하도록 요구할 수 있으며, 회사가 요구를 받은 날 부터 2개월 이내에 그 청구를 하지 아니하는 경우에는 그 주주는 회사를 대위(代位)하여 청구를 할 수 있다는 뜻
    ④ 제3항의 공시기간은 증권선물위원회로부터 단기매매차익 발생 사실을 통보받은 날부터 2년간 또는 단기매매차익을 반환받은 날 중 먼저 도래하는 날까지로 한다.

<span style="font-weight:bold;">제 15조 【 특정증권등의 매매 등에 대한 통보 】 </span>
    임원과 법 제172조제1항 및 법 시행령 제194조가 정하는 직원은 특정증권 등의 매매, 그 밖의 거래를 하는 경우 그 사실을 공시책임자에게 통보하여야 한다.

<span style="font-weight:bold;">제 16조 【 미공개중요정보의 이용행위 금지 】 </span>
...
<span style="font-weight:bold;">제 18 조 【 규정의 개폐 】 </span>
이 규정의 개정 또는 폐지는 이사회가 한다.

<span style="font-weight:bold;">제 19 조 【 규정의 공표 】 </span>
