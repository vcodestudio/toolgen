...
<div class="flex flex-col gap-4">
    ...
    <div class="flex gap-4 items-center">
        <span class="text16-500">{item.name}</span>
        <div class="flex-auto">
            <div class="{colors[i%colors.length]} rounded-full flex justify-end p-[1em] py-[0.5em] text-white text14-500" style="width:{item.percent}">
                {item.value}
            </div>
        </div>
    </div>
